...
import com.example.newsappusingrestapi.Listeners.OnFetchDataListener;
import com.example.newsappusingrestapi.Listeners.SelectListener;
import com.example.newsappusingrestapi.Models.NewsApiResponse;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SelectListener {
    ...
    private void showNews(List<NewsHeadline> headlines) {
        ...
        customAdapter = new CustomAdapter(MainActivity.this, headlines,this::OnNewsClicked);
